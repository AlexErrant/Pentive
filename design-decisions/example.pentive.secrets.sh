...
export developmentPublicMediaSecret=
export productionPublicMediaSecret=
...
export VITE_DEVELOPMENT_IFRAME_RESIZER_LICENSE=
export VITE_PRODUCTION_IFRAME_RESIZER_LICENSE=
