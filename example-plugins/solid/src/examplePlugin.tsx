...
const ExamplePlugin: VoidComponent<{
  ...
  return (
    <div
      // eslint-disable-next-line @typescript-eslint/naming-convention -- medTODO not sure why `border-red-900` isn't working, figure out later when it's time to learn CSS
